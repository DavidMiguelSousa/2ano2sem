...
**Justification and Evidences: The domain model was made, workflow and scripts were implemented, following the good practices of DDD and the base project given by the professors.**
...
**Selected Level: No deployment needed yet.**
