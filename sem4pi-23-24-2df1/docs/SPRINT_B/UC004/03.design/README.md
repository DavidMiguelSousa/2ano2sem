...
| Step 5: List all backoffice users                                         | ... showing all active backoffice users?              | ListActiveBackofficeUsersUI         | Pure Fabrication: ListUsersUI is a class created with the purpose of listing all backoffice users.                                                          |
|                                                                           | ... controlling the flow of the use case?             | ListActiveBackofficeUsersController | Controller: ListUsersController is a class created with the purpose of controlling the flow of the use case.                                                |
...
|                                                                           | ... knowing the user's role(s)?                       | SystemUser                          | Information Expert: SystemUser knows all its details.                                                                                                       |
|                                                                           | ... filter user's according to their role and status? | UserManagementService               | Service: UserManagementService is a class that provides the service of filtering users according to their role and status.                                  |
...
* MainMenu
* ListActiveBackofficeUsersUI
* ListActiveBackofficeUsersController
* SystemUserRepository
* UserManagementService

## 3.2. Sequence Diagram (SD)

![uc004-sequence-diagram.svg](svg/uc004-sequence-diagram.svg)

## 3.3. Class Diagram (CD)

![uc004-class-diagram.svg](svg/uc004-class-diagram.svg)