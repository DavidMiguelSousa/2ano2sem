# 1221124 - Tiago Carvalho - Sprint B - Self Assessment
...
**Justification and Evidences:** Use Case's were well documented, but some of them were not fully implemented or tested. Additionally, the TDD approach was not succesfully used in all moments.
...
**Justification and Evidences:** Always connected commits to issues and used relevant messages.
...
**Justification and Evidences:** Some members worked more than others and tasks were not fully implemented.
...
**Justification and Evidences:** Not all use cases were fully implemented and tested.
...
**Justification and Evidences:** Maven workflow was used to integrate the project.
...
**Justification and Evidences:** User stories were well documented and acceptance criteria were defined.