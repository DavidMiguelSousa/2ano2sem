# 1221124 - Tiago Carvalho - Sprint C - Self Assessment
...
**Justification and Evidences:** Engineering process was followed with success, starting with documentation (following a DDD approach), followed by the implementation of the system (using TDD) and ending with the deployment of the system. The process was well documented and justified.
...
**Justification and Evidences:** Overall, tasks/issues were well documented and managed, with a good connection between the repository and the issues.
...
**Justification and Evidences:** Some members of the team were not as active as others, which led to some delays in the development of the system.
...
**Justification and Evidences:** The system runs in two or more local virtual environments, but there were some minor issues during the demonstration. 
...
**Justification and Evidences:** The system was well integrated, with no incoherence or unnecessary coupling.
...
**Justification and Evidences:** All requirements were met almost in full, but there were some flaws in the interpretation that were not correctly justified.