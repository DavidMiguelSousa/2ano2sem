# 1220604 - Rodrigo Correia - Sprint A - Self Assessment
...
**Justification and Evidence: The domain model was made, workflow and scripts were implemented, following the good
practices of DDD and the base project given by the professors.**
...
**Justification and Evidence: GitHub repository setup with constant commits with meaningful commit messages.**
...
**Justification and Evidence: Every element contributed to the decisions, and the communication was constant and easy.**
...
**Justification and Evidence:** The system runs outside the IDE, using a local database.
...
**Justification and Evidence: Maven workflow was used.**
...
**Justification and Evidence: All requirements have been met.**