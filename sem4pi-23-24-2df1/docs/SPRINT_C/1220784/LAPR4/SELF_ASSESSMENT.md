# 1220784 - David Sousa - Sprint A - Self Assessment
...
**Justification and Evidences:** The domain model, workflow and scripts were used, following the good practices of DDD
and the base project given by the professors.
...
**Justification and Evidences:** Some of the team member has been working together to solve the problems and to develop
the project. All main decisions were in group.
