# 1200347 - Beatriz Silva - Sprint C - Self Assessment
...
**Justification and Evidences:** Code and design are aligned and everything is documented.
...
**Justification and Evidences:** We connect issues/tasks with commits correctly and we use significant messages for a better organization.
...
**Justification and Evidences:** We have some evidence of work with coordination between teams. Some members do not collaborate in some important phases of the project.
...
**Justification and Evidences:** We were able to demonstrate the system without any execution failures during the demonstration. The correct version was used.
...
**Justification and Evidences:** There is integration between most components/functionality, presenting some inconsistencies and/or unnecessary coupling.
...
**Justification and Evidences:** For this sprint, all requirements were met almost in full and any options related to the interpretation/analysis of the problem are correctly justified. Incomplete definition of acceptance criteria. Tests were conducted for most of the acceptance criteria.